...
void SetupAfterNetworkGameRunning(bool bNetworkMain)
{
	...
	if (DOES_SCRIPT_EXIST("ambControlLoader"))
		LoadScript("ambControlLoader", 1024);
#if !defined(SUBTARGET) || SUBTARGET==SUBTARGET_TBOGT
#if 0 // pointless, serves no purpose!
	if (DOES_SCRIPT_EXIST("ambDebug"))
...
#if 1
	if (DOES_SCRIPT_EXIST("puzzle_launcher") && DOES_SCRIPT_EXIST("ambTV") && DOES_SCRIPT_EXIST("ambClubLights"))
	{
	...
	if (DOES_SCRIPT_EXIST("EmpireTelescope") && DOES_SCRIPT_EXIST("EmpireDown") && DOES_SCRIPT_EXIST("cablecars"))
	{
...
#if 0
	if (DOES_SCRIPT_EXIST("garbage_trucks") && DOES_SCRIPT_EXIST("ambbeggar") && DOES_SCRIPT_EXIST("ambpimpnpros") && DOES_SCRIPT_EXIST("ambdealer") && DOES_SCRIPT_EXIST("ambpreacher") && DOES_SCRIPT_EXIST("ambbusker"))
	{
